        ...
        <div className="space-y-6 max-w-[1000px] mx-auto animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className={`px-6 py-3 rounded-lg text-xs font-bold uppercase tracking-widest transition-all ${isSaved
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-base text-white focus:outline-none focus:border-wts-green/50"
                        >
            ...
            <div className="bg-black/40 border border-white/5 rounded-xl p-6">
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2 md:col-span-1">
                            ...
                            <input
                                ...
                                className="w-full bg-black/20 border border-white/10 rounded-lg p-3 text-base text-white focus:outline-none focus:border-wts-green/50"
                            />
                        </div>
                        <div className="col-span-2 md:col-span-1">
                            <label className="text-xs font-bold text-gray-600 uppercase tracking-widest block mb-2">
                    ...
                    <div>
                        ...
                        <select className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-base text-white focus:outline-none focus:border-wts-green/50">
            ...
            <div className="bg-black/40 border border-white/5 rounded-xl p-6">
                ...
                <div className="space-y-3">
                    <label className="flex items-center justify-between p-3 bg-white/5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors">
                        <span className="text-xs font-bold text-white">{t('settings.fixture_reminders')}</span>
                        <input type="checkbox" defaultChecked className="w-5 h-5" />
                    </label>
                    <label className="flex items-center justify-between p-3 bg-white/5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors">
                        <span className="text-xs font-bold text-white">{t('settings.availability_notifs')}</span>
                        <input type="checkbox" defaultChecked className="w-5 h-5" />
                    </label>
                    <label className="flex items-center justify-between p-3 bg-white/5 rounded-lg cursor-pointer hover:bg-white/10 transition-colors">
                        <span className="text-xs font-bold text-white">{t('settings.payment_reminders')}</span>
                        <input type="checkbox" defaultChecked className="w-5 h-5" />
                    </label>
                </div>
            </div>
            ...
            <div className="bg-black/40 border border-wts-green/20 rounded-xl p-6">
                <div className="flex items-center space-x-3 mb-5">
                    <div className="p-2 bg-wts-green/10 rounded-md">
                        <Shield className="text-wts-green w-5 h-5" />
                    </div>
                    <h3 className="font-bold text-sm uppercase tracking-[0.15em] text-white">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-base font-bold text-white">{t('settings.current_plan')}</p>
                            <p className="text-xs text-gray-500 font-mono">{t('settings.active_since')} Dec 2024</p>
                        </div>
                        <div className="px-3 py-1.5 bg-wts-green/10 border border-wts-green/20 rounded">
                            <span className="text-xs font-bold text-wts-green uppercase tracking-widest">
                                Premium Pro
                            </span>
                        </div>
                    </div>
                    <button className="w-full py-3 px-4 bg-white/5 border border-white/10 rounded-lg text-xs font-bold uppercase tracking-widest text-white hover:bg-white/10 transition-colors">
